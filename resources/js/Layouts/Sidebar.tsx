                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <NavLink href="/apps/scrumboard" active={false} className="group">
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        opacity="0.5"
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'component' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink href="/components/tabs" active={false}>Tabs</NavLink>
                                        </li>
                                        <li>
                                            <NavLink href="/components/accordions" active={false}>Accordions</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            <li className="menu nav-item">
                                <NavLink href="/widgets" active={false} className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                            ...
                            <li className="menu nav-item">
                                <NavLink href="/font-icons" active={false} className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Font Icons</span>
                                    </div>
                                </NavLink>
                            </li>
                        </ul>
