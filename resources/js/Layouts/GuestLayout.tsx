...
export default function Guest({ children, featuredImage }: PropsWithChildrenAndImage) {
    return (
          ...
          <div className="main-container min-h-screen text-black dark:text-white-dark">
                <div>
                  <div className="absolute inset-0">
                    <img src={bgGradientImage} alt="image" className="h-full w-full object-cover" />
                  </div>
                  <div 
                    ...
                    <img src={comingSoonObject1} alt="image" className="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                    <img src={comingSoonObject2} alt="image" className="absolute left-24 top-0 h-40 md:left-[30%]" />
                    <img src={comingSoonObject3} alt="image" className="absolute right-0 top-0 h-[300px]" />
                    <img src={polygonObject} alt="image" className="absolute bottom-0 end-[28%]" />
                    <div className="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                        ...
                        <div className="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                          ...
                          {featuredImage != null && (
                            <div className="mt-24 hidden w-full max-w-[430px] lg:block">
                                <img src={featuredImage} alt="Featured Image" className="w-full" />
                            </div>
                          )}
                        </div>
                      </div>
                      <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        ...
                        <p className="absolute bottom-6 w-full text-center dark:text-white">© {new Date().getFullYear()}.{APP_NAME} All Rights Reserved.</p>
                      </div>
                    </div>
                  </div>
                </div>
