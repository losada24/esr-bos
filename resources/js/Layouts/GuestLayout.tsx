      ...
      <div className="main-container min-h-screen text-black dark:text-white-dark">
        <div>
          ...
          >
            ...
            />
            <div className="relative flex w-full max-w-[602px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:flex-row lg:gap-10 xl:gap-0">
