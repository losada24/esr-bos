        ...
        <PrintLayout>
          <Page size="A4" style={tw('p-6 font-regular')}>
            ...
            <View style={tw('flex flex-row gap-4 justify-between border-b border-gray-200 mb-3 p-3')}>
              <Text style={tw('text-xs text-white-dark text-black font-bold w-2/12')}>Raw Material</Text>
              ...
              <Text style={tw('text-xs text-white-dark text-black font-bold w-2/12')}>Visual Id</Text>
            </View>
            {orderCuttingList.map((product, index) => {
              return <View style={tw('flex flex-row gap-4 items-center justify-between border-b border-gray-200 mb-3 p-3')} key={index}>
                <Text style={tw('text-xs text-gray-900 font-regular w-2/12')}>{product.material}</Text>
