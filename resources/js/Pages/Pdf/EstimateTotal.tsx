    ...
    <View style={tw('flex flex-row mt-4')}>
      ...
      <View style={tw('w-6/12')}>
        ...
        <View style={tw('flex flex-row justify-start gap-x-3')}>
          ...
          <Text style={tw('text-base text-gray-900 font-regular w-6/12 text-left')}>{`$${getTaxAmount(order)}`}</Text>
        </View>
        <View style={tw('flex flex-row justify-start gap-x-3')}>
          <Text style={tw('text-base text-gray-900 font-bold w-6/12 text-right')}>Installation:</Text>
          <Text style={tw('text-base text-gray-900 font-regular w-6/12 text-left')}>{`$${order.installation}`}</Text>
        </View>
        <View style={tw('flex flex-row justify-start gap-x-3')}>
          <Text style={tw('text-base text-gray-900 font-bold w-6/12 text-right')}>Permit:</Text>
          <Text style={tw('text-base text-gray-900 font-regular w-6/12 text-left')}>{`$${order.permit}`}</Text>
        </View>
        <View style={tw('flex flex-row justify-start gap-x-3')}>
          <Text style={tw('text-base text-gray-900 font-bold w-6/12 text-right')}>Other:</Text>
          <Text style={tw('text-base text-gray-900 font-regular w-6/12 text-left')}>{`$${order.other}`}</Text>
        </View>
        <View style={tw('flex flex-row justify-start gap-x-3')}>
          <Text style={tw('text-base text-gray-900 font-bold w-6/12 text-right')}>Grand Total:</Text>
          <Text style={tw('text-base text-gray-900 font-regular w-6/12 text-left')}>{`$${getGrandTotal(order)}`}</Text>
        </View>
      </View>
    </View>
  )
