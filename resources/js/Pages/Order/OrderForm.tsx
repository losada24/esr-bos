    ...
    <Form className='space-y-5'>
      ...
      <fieldset className='p-3 border rounded-xl'>
        ...
        <div className='grid gap-4 grid-cols-4'>
          ...
          <div className={submitCount ? (errors.city_permits) ? 'has-error inline-flex flex-col' : 'has-success inline-flex' : 'inline-flex'}>
              <div className='flex'>
                <Field
                  id="city_permits"
                  name="city_permits"
          ...
          <div className={submitCount ? (errors.association_permits) ? 'has-error inline-flex flex-col' : 'has-success inline-flex' : 'inline-flex'}>
              <div className='flex'>
                <Field
