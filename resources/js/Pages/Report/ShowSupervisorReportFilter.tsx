...
interface ShowSupervisorReportFilterProps {
...
const ShowSupervisorReportFilter: React.FC<ShowSupervisorReportFilterProps> = ({ id, statuses }) => {
  ...
  const reset = () => {
    ...
    router.get(route('report.show-supervisor-report', { id }), {
      status: '',
      name: '',
      start_date: '',
      end_date: ''
  ...
  const submit = (e: SyntheticEvent) => {
    ...
    if (currentRoute === undefined) {
      currentRoute = 'report.show-supervisor-report'
    }
    // console.log(data)
...
export default ShowSupervisorReportFilter
