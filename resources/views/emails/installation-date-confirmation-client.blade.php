...
<p> Good day:</p>
    ...
    <hr/>
    <p>Buen día:</p>
    <p>Su entrega está confirmado para:{{ \Carbon\Carbon::parse($order->delivery_date)->format('m-d-Y')}} y su instalación para:{{ \Carbon\Carbon::parse($order->installation_date)->format('m-d-Y')}} . Por favor recuerde remover los pequeños objetos del área de instalación así como las cortinas en modo que el trabajo fluya más rápida y tranquilamente.</p>
