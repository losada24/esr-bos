<div>
    ...
    <p>The balance due on the delivery day is:{{'$' . number_format($order->cost_delivery  , 2, '.', ',') }}. You can make the payment by handing over a check, making a Zelle to Reylos Glass Inc., by wire transfer or paying with a card through the office. See attached form.</p>
    ...
    <p>El monto a pagar el día de la entrega es de: {{'$' . number_format($order->cost_delivery  , 2, '.', ',') }}. Puede realizar el pago entregando un cheque, realizando un Zelle a Reylos Glass Inc., por wire transfer o pagando con tarjeta. Ver formulario adjunto.</p>
