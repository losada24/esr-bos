...
use App\Http\Controllers\StrictlyZeroWebhookController;
...
Route::post('/webhook/strictly-zero/payments', [StrictlyZeroWebhookController::class, 'payments'])
  ->name('strictly-zero.webhooks.payments');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/administration/overdue-report-email-schedule', [OverdueReportEmailScheduleController::class, 'index'])
      ->middleware(["role:" . RoleEnum::ADMIN->value])
      ->name('overdue-report-email-schedule.index');
    Route::put('/administration/overdue-report-email-schedule', [OverdueReportEmailScheduleController::class, 'update'])
      ->middleware(["role:" . RoleEnum::ADMIN->value])
      ->name('overdue-report-email-schedule.update');
    ...
    Route::get('/dashboard/whatsapp', [DashboardController::class, 'whatsapp'])
      ...
      Route::post('/payment-installments/{installment}/credit-transfers', [PaymentInstallmentMovementController::class, 'transferCredit'])
        ->middleware(["role:" . RoleEnum::ADMIN->value . '|'. RoleEnum::ACCOUNT_MANAGER->value . '|'. RoleEnum::ACCOUNTING->value . '|'. RoleEnum::OWNER_ADMIN->value . '|'. RoleEnum::OWNER->value. '|'. RoleEnum::FRONTDESK_ADMIN->value])
        ->name('payment_installment_credit_transfers.store');

      Route::post('/orders/{order}/city-fee-payment', [OrderPaymentController::class, 'storeCityFee'])
        ->middleware(["role:" . RoleEnum::ADMIN->value . '|'. RoleEnum::ACCOUNT_MANAGER->value . '|'. RoleEnum::ACCOUNTING->value . '|'. RoleEnum::OWNER_ADMIN->value . '|'. RoleEnum::OWNER->value. '|'. RoleEnum::FRONTDESK_ADMIN->value])
        ->name('order_payments.city_fee.store');
