...
class UpdateInstallationTeamRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'worker_compensation_attach' => 'nullable|file|mimes:jpeg,png,jpg,pdf,docx,doc,xlsx|max:2048',
            'liability_expiration_attach' => 'nullable|file|mimes:jpeg,png,jpg,pdf,docx,doc,xlsx|max:2048',
