...
class StoreInstallationTeamRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'worker_compensation_attach' => 'required|file|mimes:jpeg,png,jpg,pdf,docx,doc,xlsx|max:2048',
            'liability_expiration_attach' => 'required|file|mimes:jpeg,png,jpg,pdf,docx,doc,xlsx|max:2048',
