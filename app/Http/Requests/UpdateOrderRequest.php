    ...
    {   
      return [
          ...
          'orderProducts.*.extra_works' => 'nullable|array',
            ...
            'phases.*.position' => ['nullable', 'integer', 'min:1'],
            ...
            'phases.*.delivery_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.installation_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.installation_end_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.inspection_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.finish_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.service_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.pending_collect' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.final_inspection_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.complete_date' => ['nullable', 'date_format:Y-m-d'],
            'phases.*.supervisor_id' => ['nullable', 'integer', 'exists:users,id'],
            'phases.*.installation_teams' => ['nullable', 'array'],
            'phases.*.installation_teams.*' => ['nullable', 'integer', 'exists:installation_teams,id'],
            'phases.*.products' => ['nullable', 'array'],
            'phases.*.products.*.order_product_id' => ['nullable', 'integer'],
            'phases.*.products.*.product_index' => ['nullable', 'integer', 'min:0'],
            'phases.*.products.*.qty' => ['nullable', 'numeric', 'min:0'],
            'phases.*.replanned_reasons' => ['nullable', 'array'],
            'phases.*.notes' => ['nullable', 'string', 'max:2000'],
        ];
    }
